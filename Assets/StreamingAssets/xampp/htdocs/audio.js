...
var audio_18 = document.getElementById("audio_18"); //audio
...
audio_18.addEventListener("playing", function (_event) {
  var duration = _event.target.duration;
  advance(duration, audio_18);
});
audio_18.addEventListener("pause", function (_event) {
  clearTimeout(timer);
});
